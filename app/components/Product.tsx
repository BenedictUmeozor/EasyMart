...
export default function Product() {
  return (
    <div className="h-[300px] flex flex-col rounded-md  shadow-lg">
      <div className="product-image relative h-[70%] w-full bg-secondary flex items-center justify-center overflow-hidden">
        <Image
      ...
      <div className="w-full h-[30%] p-1">
        ...
        <Rating value={4.69} className="max-w-[100px] text-xs" readOnly />
      </div>
    </div>
  );
}
